...
download.file(url = "https://github.com/weizhou2273/data624/blob/master/project1_data/ATM624Data.xlsx?raw=true", 
              destfile = temp_file, 
              mode = "wb", 
              quiet = TRUE)
ATM <- readxl::read_excel(temp_file,skip=0,col_types = c("date","text","numeric"))
download.file(url = "https://github.com/weizhou2273/data624/blob/master/project1_data/ResidentialCustomerForecastLoad-624.xlsx?raw=true", 
              destfile = temp_file, 
              mode = "wb", 
              quiet = TRUE)
power <- readxl::read_excel(temp_file,skip=0,col_types = c("numeric","text","numeric"))
download.file(url = "https://github.com/weizhou2273/data624/blob/master/project1_data/Waterflow_Pipe1.xlsx?raw=true", 
              destfile = temp_file, 
              mode = "wb", 
              quiet = TRUE)
water1 <- readxl::read_excel(temp_file,skip=0,col_types = c("date","numeric"))
download.file(url = "https://github.com/weizhou2273/data624/blob/master/project1_data/Waterflow_Pipe2.xlsx?raw=true", 
              destfile = temp_file, 
              mode = "wb", 
              quiet = TRUE)
...
p <- ggplot(ATM[complete.cases(ATM),],aes(x=DATE,y=Cash))+
  geom_line()
p + facet_grid(rows = vars(ATM),scales="free")
p <- ggplot(ATM[complete.cases(ATM),],aes(x=Cash))+
  geom_histogram()
